...
const Card = ({title, content}) => {
  return (
    <div className="bg-primary px-8 py-10 rounded-lg flex flex-wrap space-x-8">
      ...
      <div className="relative mb-12 md:mb-16 lg:mb-20 pt-2 pb-4 md:pt-10 md:pb-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:px-4 lg:px-6 gap-6 lg:gap-10">
          ...
          <Card
            ...
            content={`No paper or misplaced records. Have access to all your customer and delivery 
            records in one central place with daily automated backups to avoid loss.`}
          />
          <Card
            title="Plan and optimise your delivery routes automatically"
            content={`Instantly get the most efficient routes and schedules 
            for your drivers, plus increase the number of orders 
            performed, while saving costs on fuel and time.`}
          />
        </div>
      </div>
    </div>
